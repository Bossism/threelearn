...
export default {
  ...
  methods: {
    ...
    createScene() {
      ...
      var axesHelper = new THREE.AxesHelper(100); // 参数是线段尺寸大小
    ...
    createCamera() {
      ...
      this.camera.position.set(10, 10, 100); // 设置相机位置
 
      this.camera.lookAt(new THREE.Vector3(10, 40, 0)); // 设置相机方向 相机要指向的点的坐标
